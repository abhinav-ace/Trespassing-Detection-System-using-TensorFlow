...
top_label=Label(root,text='TRESSPASSING DETECTION USING TENSORFLOW',font=font.Font(size=20),bd=1,bg='gray',fg='white')
...
# STATUS BAR
status_bar=Label(root,text='Coded and Developed by : Nilesh Tanwar, Pankaj Joshi and Abhinav Jain.',relief=SUNKEN,bd=1,font=font.Font(size=12))
